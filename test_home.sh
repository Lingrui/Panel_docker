docker run --rm -it -v /usr/bin/docker:/usr/bin/docker -v /var/run/docker.sock:/var/run/docker.sock -v /usr/lib/x86_64-linux-gnu/libapparmor.so.1:/usr/lib/x86_64-linux-gnu/libapparmor.so.1 -v /nas/rawdata:/rawdata -v /home/mh01/test_panel/report:/report -v /home/mh01/test_panel/log:/log -v /home/mh01/test_panel/tmp:/tmp -v /ref:/ref -v /nas/common/gtf:/gtf -v /nas/common/bed:/bed \
-e RAWDATA_PATH="/nas/rawdata/" -e REPORT_PATH="/home/mh01/test_panel/report" -e LOG_PATH="/home/mh01/test_panel/log" -e TMP_PATH="/home/mh01/test_panel/tmp" -e REF_PATH="/ref" \
